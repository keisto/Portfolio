<template>
    <div class="animated fadeInUp">
        ...
        <p class="mb-8 leading-loose">
            My mobile application Navo <span class="hint">(iOS)</span> has been updated to use Algolia's InstantSearch, GoogleAs, add Apple's StoreKit. Navo is an oil and gas locator application with over 1000 downloads in North Dakota <span class="hint">(targeted audience)</span>.
        </p>
